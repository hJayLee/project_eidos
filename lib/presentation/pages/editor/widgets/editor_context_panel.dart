...
class _ContentPane extends StatefulWidget {
  const _ContentPane({required this.slide, required this.onSlideUpdated});
...
class _ContentPaneState extends State<_ContentPane> {
  ...
  void didUpdateWidget(covariant _ContentPane oldWidget) {
    ...
    final slideUpdatedExternally =
        incomingSlide != null &&
        _draftSlide != null &&
        incomingSlide.updatedAt.isAfter(_draftSlide!.updatedAt);
    ...
    if (slideIdChanged || slideUpdatedExternally) {
      ...
      _bodyController.text = incomingSlide?.metadata['body']?.toString() ?? '';
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            maxLines: 2,
            decoration: const InputDecoration(hintText: '슬라이드 제목을 입력하세요'),
            onChanged: (value) {
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                tooltip: '리스트 형식 전환',
                                onPressed: () =>
                                    _toggleListType(currentSlide, element),
                                icon: Icon(
                                  (element.data['listType']?.toString() ??
                                              'bullet') ==
                                          'numbered'
            ...
            child: TextField(
              ...
              onChanged: (value) {
                final updatedSlide = currentSlide.copyWith(
                  metadata: {...currentSlide.metadata, 'body': value},
                );
                setState(() {
                  _draftSlide = updatedSlide;
                });
  ...
  void _addBulletPoint(slide_models.SlideData slide) {
    final newElement = slide_models.SlideElement.create(
      ...
      data: {'text': '새로운 핵심 포인트', 'style': 'bullet', 'listType': 'bullet'},
    );
  ...
  void _updatePoint(
    ...
    final updatedSlide = slide.updateElement(updatedElement.id, updatedElement);
    setState(() {
      _draftSlide = updatedSlide;
    });
    widget.onSlideUpdated(updatedSlide);
  ...
  void _toggleListType(
    ...
    final updatedElement = element.copyWith(
      data: {...element.data, 'listType': nextType},
    );
...
class _ListIndicator extends StatelessWidget {
  const _ListIndicator({required this.index, required this.listType});
